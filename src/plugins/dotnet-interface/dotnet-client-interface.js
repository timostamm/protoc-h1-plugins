...
class DotnetClientInterface extends Plugin {
    ...
    handleService(proto, service, serviceIndex) {
        ...
        const vars = {
            ...
            '@CLASS@': `I${service.getName()}HttpClient`,
            '@CLASS_COMMENT@': comments.service(proto, serviceIndex, "    /// ")
        };
        const template = Template.read(`${__dirname}/dotnet-client-interface.template`);
        ...
        const file = `${packageDir}/I${service.getName()}HttpClient.cs`;
...
module.exports = DotnetClientInterface;
